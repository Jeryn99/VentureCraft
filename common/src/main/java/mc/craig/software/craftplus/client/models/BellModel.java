...
public class BellModel extends HierarchicalModel implements AnimatableBEModel<BigBellBlockEntity> {
    ...
    public void animate(BigBellBlockEntity blockentity) {
        ...
        animate(blockentity.RING_START, RING_START, blockentity.getTickTime());
        animate(blockentity.RING_LOOP, RING_LOOP, blockentity.getTickTime());
        animate(blockentity.RING_STOP, RING_STOP, blockentity.getTickTime());
    }
