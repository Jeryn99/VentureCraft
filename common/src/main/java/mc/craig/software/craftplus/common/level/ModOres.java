...
public class ModOres {
    ...
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(VentureCraft.MODID, Registry.CONFIGURED_FEATURE_REGISTRY);
    public static final DeferredRegister<PlacedFeature> PLACED_FEATURES = DeferredRegister.create(VentureCraft.MODID, Registry.PLACED_FEATURE_REGISTRY);

    // Configured
    public static RegistrySupplier<ConfiguredFeature<?, ?>> ORE_SAPPHIRE_CONFIGURED = CONFIGURED_FEATURES.register("ore_sapphire", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ImmutableList.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.SAPPHIRE_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_SAPPHIRE_ORE.get().defaultBlockState())), 9)));
    public static RegistrySupplier<ConfiguredFeature<?, ?>> ORE_SAPPHIRE_BURIED_CONFIGURED = CONFIGURED_FEATURES.register("ore_sapphire_buried", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ImmutableList.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.SAPPHIRE_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_SAPPHIRE_ORE.get().defaultBlockState())), 4)));
    public static RegistrySupplier<ConfiguredFeature<?, ?>> ORE_SAPPHIRE_LARGE_CONFIGURED = CONFIGURED_FEATURES.register("ore_sapphire_large", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(ImmutableList.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.SAPPHIRE_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_SAPPHIRE_ORE.get().defaultBlockState())), 4)));
    public static RegistrySupplier<ConfiguredFeature<?, ?>> ORE_RUBY_CONFIGURED = CONFIGURED_FEATURES.register("ore_ruby", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.RUBY_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_RUBY_ORE.get().defaultBlockState())), 3)));
    public static RegistrySupplier<ConfiguredFeature<?, ?>> ORE_DIAMOND_CONFIGURED = CONFIGURED_FEATURES.register("ore_diamond", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, Blocks.DIAMOND_ORE.defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, Blocks.DEEPSLATE_DIAMOND_ORE.defaultBlockState())), 3)));


    // Placed
    public static RegistrySupplier<PlacedFeature> ORE_SAPPHIRE_BURIED = PLACED_FEATURES.register("ore_sapphire_buried", () -> new PlacedFeature(Holder.direct(ORE_SAPPHIRE_BURIED_CONFIGURED.get()), List.copyOf(commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))))));
