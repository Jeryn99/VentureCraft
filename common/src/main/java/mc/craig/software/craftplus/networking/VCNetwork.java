...
public class VCNetwork {
    ...
    public static MessageType TOGGLE_GLIDE, SYNC_CAP, PLAY_SOUND, SYNC_EXTENDED_INV, SYNC_SKILL_POINTS;
    ...
    public static void init() {
        ...
        SYNC_SKILL_POINTS = INSTANCE.registerS2C("sync_skill_points", SyncSkillPointsMessage::new);
    }
}
