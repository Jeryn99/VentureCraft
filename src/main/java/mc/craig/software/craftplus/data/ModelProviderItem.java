    ...
    protected void registerModels() {
        for (RegistryObject<Item> entry : ModItems.ITEMS.getEntries()) {
            ...
            if (entry.get() instanceof ArmorItem) {
                layeredItem(Objects.requireNonNull(ForgeRegistries.ITEMS.getKey(entry.get())), new ResourceLocation(MinecraftPlus.MODID, ForgeRegistries.ITEMS.getKey(entry.get()).getPath() + "_overlay"));
                continue;
            }
